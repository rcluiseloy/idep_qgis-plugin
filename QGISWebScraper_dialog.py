...
class Ui_QGISWebScraperDialogBase(object):
    def setupUi(self, QGISWebScraperDialogBase):
        ...
        QGISWebScraperDialogBase.setWindowIcon(QtGui.QIcon('resources/logo.png'))
        ...
        # Add QComboBox for filtering
        #self.organismoComboBox = QtWidgets.QComboBox(QGISWebScraperDialogBase)
        #self.organismoComboBox.setObjectName("entidadFiltre")
        #self.verticalLayout.addWidget(self.organismoComboBox)
    ...
    def retranslateUi(self, QGISWebScraperDialogBase):
        ...
        QGISWebScraperDialogBase.setWindowTitle(_translate("QGISWebScraperDialogBase", "IDEPGeoServices"))
        self.wmsTreeWidget.setHeaderLabels([_translate("QGISWebScraperDialogBase", "Organismo"), _translate("QGISWebScraperDialogBase", "Enlace de Geoservicio")])
        self.importButton.setText(_translate("QGISWebScraperDialogBase", "Importar Geoservicios"))
